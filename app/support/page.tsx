    ...
    <div className="container">
      ...
      <div className="main-content">
        <div className="page-content" style={{ maxWidth: 720, textTransform: "lowercase" }}>
          <p style={{ marginBottom: "1rem" }}>for help or questions about rcl, the leaderboard, or the hub, reach out on discord.</p>
          <p style={{ marginBottom: "1rem" }}>
            contact <span className="support-username">vllis</span> or <span className="support-username">syn_acc</span> on discord.
          </p>
